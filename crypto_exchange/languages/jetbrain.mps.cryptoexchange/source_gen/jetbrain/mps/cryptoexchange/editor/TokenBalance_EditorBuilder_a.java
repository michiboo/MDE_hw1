...
/*package*/ class TokenBalance_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public TokenBalance_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_ozr2o4_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    if (nodeCondition_ozr2o4_a0a()) {
  ...
  private boolean nodeCondition_ozr2o4_a0a() {
    return (SLinkOperations.getTarget(myNode, LINKS.token$WJby) == null);
  }
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.token$WJby;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.token$WJby);
    }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_ozr2o4_c0");
  ...
  private EditorCell createProperty_2() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.balance$WJS_;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
