...
/*package*/ class order_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_x470sv_a");
    ...
    if (nodeCondition_x470sv_a31a()) {
      editorCell.addEditorCell(createConstant_7());
    }
    if (nodeCondition_x470sv_a41a()) {
      editorCell.addEditorCell(createProperty_6());
    }
    editorCell.addEditorCell(createConstant_8());
    return editorCell;
  }
  private boolean nodeCondition_x470sv_a31a() {
    return SPropertyOperations.getEnum(myNode, PROPS.type$NX9t).toString() == "leverageLong" || SPropertyOperations.getEnum(myNode, PROPS.type$NX9t).toString() == "leverageShort";
  }
  private boolean nodeCondition_x470sv_a41a() {
    return SPropertyOperations.getEnum(myNode, PROPS.type$NX9t).toString() == "leverageLong" || SPropertyOperations.getEnum(myNode, PROPS.type$NX9t).toString() == "leverageShort";
  }
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Order ");
    editorCell.setCellId("Constant_x470sv_a0");
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.ID$9Jt2;
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_x470sv_c0");
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "TokenPair:");
    editorCell.setCellId("Constant_x470sv_d0");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.TokenPair$9Qvw;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.TokenPair$9Qvw);
    ...
    provider.setNoTargetText("<no TokenPair>");
    EditorCell editorCell = provider.createCell();

    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.TokenPair$9Qvw);
    }
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createConstant_3() {
    ...
    editorCell.setCellId("Constant_x470sv_f0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createProperty_2() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.amount$BBkE;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
  ...
  private EditorCell createConstant_4() {
    ...
    editorCell.setCellId("Constant_x470sv_h0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefCell_1() {
    final SReferenceLink referenceLink = LINKS.account$9L69;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
    ...
    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.account$9L69);
    }
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createConstant_5() {
    ...
    editorCell.setCellId("Constant_x470sv_j0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createProperty_4() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.type$NX9t;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
  ...
  private EditorCell createConstant_6() {
    ...
    editorCell.setCellId("Constant_x470sv_l0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createProperty_5() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.Price$9Kp6;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
  ...
  private EditorCell createConstant_7() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "leverage:");
    editorCell.setCellId("Constant_x470sv_n0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createProperty_6() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.leverage$Yjtr;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
      editorCell.setDefaultText("<no leverage>");
      editorCell.setCellId("property_leverage");
      Style style = new StyleImpl();
      style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
      editorCell.getStyle().putAll(style);
      editorCell.setSubstituteInfo(new SPropertySubstituteInfo(editorCell, property));
  ...
  private EditorCell createConstant_8() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "}");
    editorCell.setCellId("Constant_x470sv_p0");
    editorCell.setDefaultText("");
    return editorCell;
  }

  private static final class PROPS {
    /*package*/ static final SProperty type$NX9t = MetaAdapterFactory.getProperty(0x885932350df545d0L, 0xbc76936b0ff5f304L, 0x2a868524b103cefcL, 0x19d5f9c39011d202L, "type");
    ...
    /*package*/ static final SProperty Price$9Kp6 = MetaAdapterFactory.getProperty(0x885932350df545d0L, 0xbc76936b0ff5f304L, 0x2a868524b103cefcL, 0x2a868524b103cf03L, "Price");
    /*package*/ static final SProperty leverage$Yjtr = MetaAdapterFactory.getProperty(0x885932350df545d0L, 0xbc76936b0ff5f304L, 0x2a868524b103cefcL, 0x3b9502d85a7d5e9dL, "leverage");
  }
